  ...
  return (
    <footer id="store-footer" className="bg-[#121214] text-stone-300 pt-16 pb-12 border-t border-stone-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="pt-1 flex flex-wrap items-center gap-2">
              <button
                ...
                aria-label={lang === 'ar' ? 'معلومات الدومين المعتمد وتشفير SSL' : 'Official domain information and SSL encryption'}
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-stone-900 hover:bg-stone-800 text-amber-300 text-xs font-mono border border-amber-500/40 transition-colors cursor-pointer"
              >
                <ShieldCheck className="w-3.5 h-3.5 text-amber-400" />
                <span>xn--mgblao3hjb.store</span>
              </button>

              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-stone-900 text-emerald-400 text-[11px] border border-stone-700 font-medium">
                <Lock className="w-3 h-3" />
                <span>256-bit SSL</span>
              </span>

              <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-stone-900 text-amber-300 text-[11px] border border-stone-700 font-mono font-medium">
                AdSense Ready ✓
              </span>
            </div>
          </div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <button 
                  ...
                  className="hover:text-amber-300 transition-colors cursor-pointer text-stone-300 hover:underline"
                >
              ...
              <li>
                <button 
                  ...
                  className="hover:text-amber-300 transition-colors cursor-pointer text-amber-400 font-bold hover:underline"
                >
              ...
              <li>
                <button
                  ...
                  className="hover:text-blue-300 transition-colors cursor-pointer text-blue-300 font-medium hover:underline flex items-center gap-1"
                >
              ...
              <li className="flex items-center gap-2 pt-1 font-mono text-[11px]">
                <button 
                  ...
                  className="hover:text-blue-300 text-stone-300 hover:underline cursor-pointer bg-transparent border-0 p-0 font-mono text-[11px]"
                >
                  sitemap.xml
                </button>
                ...
                <button 
                  ...
                  className="hover:text-amber-300 text-stone-300 hover:underline cursor-pointer bg-transparent border-0 p-0 font-mono text-[11px]"
                >
                  robots.txt
                </button>
                <span className="text-stone-500">•</span>
                <button 
                  ...
                  className="hover:text-emerald-300 text-stone-300 hover:underline cursor-pointer bg-transparent border-0 p-0 font-mono text-[11px]"
                >
                  ads.txt
                </button>
              </li>
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="flex gap-2">
                <input
                  ...
                  aria-label={lang === 'ar' ? 'البريد الإلكتروني للاشتراك في نادي حنان ستور' : 'Email for Hanan Store newsletter'}
                  className="flex-1 bg-stone-900 text-stone-200 placeholder:text-stone-400 text-xs rounded-xl py-2.5 px-3.5 border border-stone-700 focus:outline-none focus:border-amber-500"
                />
                <button
                  type="submit"
                  aria-label={lang === 'ar' ? 'اشتراك في نادي حنان VIP' : 'Subscribe to Hanan VIP Club'}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-xs text-stone-200">
          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-stone-900/90 border border-stone-750 border-stone-700">
            ...
            <div>
              ...
              <a href="https://wa.me/966500000000" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300 font-mono text-stone-250 text-stone-200">
                +966 50 000 0000
              </a>
            </div>
          </div>

          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-stone-900/90 border border-stone-700">
            <Mail className="w-5 h-5 text-amber-400 shrink-0" />
            <div>
              <span className="block font-bold text-white">{lang === 'ar' ? 'البريد الرسمي للدعم' : 'Official Support Email'}</span>
              <a href="mailto:support@hanan.store" className="hover:text-amber-300 font-mono text-stone-200">
                support@hanan.store
              </a>
            </div>
          </div>

          <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-stone-900/90 border border-stone-700 sm:col-span-2 lg:col-span-1">
            ...
            <div>
              ...
              <span className="text-stone-200">{lang === 'ar' ? 'المملكة العربية السعودية - الرياض' : 'Riyadh, Saudi Arabia'}</span>
            </div>
          </div>
        </div>

        {/* Bottom Tier: Accepted Payment Badges & Copyright */}
        <div className="pt-8 border-t border-stone-800 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-start text-xs text-stone-300">
          
          {/* Payment Badges Strip */}
          <div className="flex items-center gap-2 flex-wrap justify-center">
            <span className="text-[11px] font-bold text-stone-200 me-1">
              {lang === 'ar' ? 'وسائل الدفع المعتمدة:' : 'Payment Partners:'}
            </span>
            <span className="px-2.5 py-1 rounded bg-stone-900 text-stone-100 font-bold border border-stone-700 text-[10px]">
              مدى Mada
            </span>
            <span className="px-2.5 py-1 rounded bg-stone-900 text-stone-100 font-bold border border-stone-700 text-[10px]">
              Apple Pay
            ...
            <span className="px-2.5 py-1 rounded bg-stone-900 text-emerald-400 font-bold border border-stone-700 text-[10px]">
              تابي Tabby
            </span>
            <span className="px-2.5 py-1 rounded bg-stone-900 text-amber-300 font-bold border border-stone-700 text-[10px]">
              تمارا Tamara
            </span>
          </div>

          {/* Copyright and Domain Credit */}
          <div className="flex flex-col sm:flex-row items-center gap-2 text-stone-300">
            ...
            {onOpenLegal && (
              <div className="flex items-center gap-2.5 text-[11px] text-stone-300 flex-wrap justify-center sm:ms-3">
                ...
                <span>•</span>
                <button onClick={() => onOpenLegal('adsense')} className="hover:text-amber-300 transition-colors cursor-pointer text-amber-400 font-bold">
                ...
                {onOpenSearchConsole && (
                  <>
                    <span>•</span>
                    <button onClick={onOpenSearchConsole} className="hover:text-blue-300 transition-colors cursor-pointer text-blue-300 font-medium">
